...
- (void)setObjectValue:(id)objectValue {
    ...
    [_outNameTextField bind:NSValueBinding toObject:obj withKeyPath:@"outputFileName" options:nil];
    [_outNameTextField bind:NSToolTipBinding toObject:obj withKeyPath:@"outputPath" options:nil];
